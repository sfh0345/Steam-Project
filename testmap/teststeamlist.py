...
def get_friend_usernames(api_key, steam_id):
    ...
    if response.status_code == 200:
        ...
        friend_ids = [friend['steamid'] for friend in friend_data['friendslist']['friends'][:8]]
        ...
        if response.status_code == 200:
            ...
            remaining_friends = len(friend_data['friendslist']['friends']) - 8
            print(f"\n{remaining_friends} remaining friends online.")
        else:
